...
import { withMulti, withObservable } from '../hoc/hoc';
import { keyring } from '@polkadot/ui-keyring';
import { createOptionItem } from '@polkadot/ui-keyring/options/item';
import { isNull, isUndefined } from '@polkadot/util';

import Dropdown from './dropdown';
import { toAddress, getAddressName } from '@patract/utils';
...
class InputAddress extends React.PureComponent<Props, State> {
  ...
  private onChangeMulti = (addresses: string[]): void => {
    ...
    if (onChangeMulti) {
      onChangeMulti(addresses.map(transformToAccountId).filter((address): string => address as string) as string[]);
    }
  };
